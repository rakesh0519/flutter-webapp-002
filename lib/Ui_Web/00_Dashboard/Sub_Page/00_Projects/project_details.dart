                            ...
                            Expanded(
                              child: InkWell(
                                ...
                                child: Container(
                                  decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(8),
                                    border: Border.all(color: selected == "scan" ? AppColors.mainGreen : AppColors.borderColor)
                                  ),
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      selected == "scan"
                                          ?
                                      Image.asset("Assets/icons/ic_checkbox_fill.png",width: 15,)
                                          :
                                      Image.asset("Assets/icons/ic_checkbox.png",width: 15,)
                            ...
                            Expanded(
                              child: InkWell(
                                ...
                                child: Container(
                                  decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(8),
                                      border: Border.all(color: selected == "upload" ? AppColors.mainGreen : AppColors.borderColor)
                                  ),
                                  padding: EdgeInsets.symmetric(horizontal: 15,vertical: 15),
                                  child: Row(
                                    children: [
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Image.asset("Assets/icons/ic_add_people.png",width: 40),
                        Spacer(),
                        InkWell(
                            onTap: () {
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Icon(Icons.keyboard_arrow_down_rounded,color: AppColors.fontLightBlack)
