...
class _SettingScreenState extends State<SettingScreen> {
  ...
  TextEditingController titleController = TextEditingController(text: "Untitled UI");
  TextEditingController tagController = TextEditingController(text: "Untitled UI is the ultimate Figma UI kit and design system. Kickstart any project and level up as a designer.");
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                decoration: BoxDecoration(
                                    border: Border.all(color: AppColors.fontGrey.withOpacity(0.4)),
                                    borderRadius: BorderRadius.circular(6)
                                ),
                                child: Row(
                                  children: [
                                    ...
                                    Image.asset("Assets/icons/ic_help.png",width: 15,height: 15),
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Image.asset("Assets/icons/ic_checkbox_fill.png",width: 16,height: 16,),
                                  ),
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            SizedBox(width: 6),
                            Image.asset("Assets/icons/ic_arrow.png",width: 20,height: 20,)
                          ],
                        ),
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Image.asset("Assets/icons/ic_delete_big.png",width: 40),
                        Spacer(),
                        InkWell(
                            onTap: () {
